...
<html lang="en" dir="ltr">
  <head>
    ...
    <title>US Senate &mdash; Pacific Model United Nations</title>
...
-->
      ...
      <div class="landing committeepage">
        ...
        <img id="imgbg" src="../committees/img/ussenate.jpg" alt="">
        <div class="frontpage">
          <div class="left">

            <h1 data-aos="fade-up"
                data-aos-delay="150"
                data-aos-duration="1000" data-aos-once="true">United States Senate</h1>
            <h3 data-aos="fade-up"
                data-aos-delay="300"
          ...
          <div class="right">
            ...
            data-aos-duration="1000" data-aos-once="true" class="landinglogo" src="./img/US-SENATE.png" alt="logo" />
          </div>
        </div>
      </div>

      <main id="committeepage">
        <div class="topsection topicbg ussenatetopica">
          <div class="container">
            <h2 data-aos="fade-up"
                data-aos-duration="1000" data-aos-once="true">Topic A</h2>
            <h1 data-aos="fade-up"
                data-aos-delay="150"
                data-aos-duration="1000" data-aos-once="true">Affirmative Action Policies in Post-Secondary Education</h1>
            <p data-aos="fade-up"
                data-aos-delay="300"
                data-aos-duration="1000" data-aos-once="true">
              In the general term of the phrase “affirmative action policies”, it tends to mean
              “those in which and institution or organization actively engages in efforts to improve
              opportunities for historically excluded groups” (NCSL). The phrase was first coined by
              President John F. Kennedy in an executive order for employment purposes in regards to
              race, creed, color, or national origin. <br><br> Policies were initially focused on improving
              opportunities for African-Americans in employment and education. For example, the Supreme
              Court’s Brown v. Board of Education decision in 1954 outlawed school segregation.
            </p>
            <div data-aos="fade-up"
                data-aos-delay="450"
                data-aos-duration="1000" data-aos-once="true" class="buttonfadeincontainer">
              <a class="button" href="backgrounders/US Senate Topic A.pdf" target="_blank">Backgrounder <div class="rightarrow">&mdash;></div></a>
            </div>
          </div>
        </div>
        <div class="classicsection topicbg ussenatetopicb">
          <div class="container inverse">
            <h2 data-aos="fade-up"
                data-aos-duration="1000" data-aos-once="true">Topic B</h2>
            <h1 data-aos="fade-up"
                data-aos-delay="150"
                data-aos-duration="1000" data-aos-once="true">Reformation of Gun Laws</h1>
            <p data-aos="fade-up"
                data-aos-delay="300"
                data-aos-duration="1000" data-aos-once="true">
              The reformation of gun laws within the United States has become an increasingly relevant issue in recent times.
              The second amendment of the constitution of the United States that “the right of people to keep
              and bear arms” (Legal Information Institute, Cornell). This allows all people within the United
              States to legally keep and bear arms, however, in recent times the interconnected violence throughout
              the United States has had many citizens calling for gun reformation laws. <br><br> It is pertinent for the
              United States Senate to find a solution to an issue that continues to tear the nation apart - one
              that is also sustainable and long-term.
            </p>
            <div data-aos="fade-up"
                data-aos-delay="450"
                data-aos-duration="1000" data-aos-once="true" class="buttonfadeincontainer">
              <a class="button" href="backgrounders/US Senate Topic B.pdf" target="_blank">Backgrounder <div class="rightarrow">&mdash;></div></a>
            </div>
          </div>
        </div>
        <div class="classicsection lowpad">
          <div class="container">
            <h2 data-aos="fade-up"
                data-aos-delay="0"
                data-aos-duration="1000" data-aos-once="true" >ussenate@pacificmun.org</h2>
            <h1 data-aos="fade-up"
                data-aos-delay="150"
            ...
            <div class="profiles"
              ...
              <div class="profile">
                <div class="profile-picture" onclick="openModal();currentSlide(1)">
                  <img src="img/staff/siddharthshende.jpg" alt="">
                </div>
                <h5>Siddharth Shende</h5>
                <h4>Director</h4>
              </div>
              <div class="profile">
                <div class="profile-picture" onclick="openModal();currentSlide(2)">
                  <img src="img/staff/irenezhang.jpg" alt="">
                </div>
                <h5>Irene Zhang</h5>
                <h4>Chair</h4>
              </div>
              <div class="profile">
                <div class="profile-picture" onclick="openModal();currentSlide(3)">
                  <img src="img/staff/hariettezhang.jpg" alt="">
                </div>
                <h5>Hariette Zhang</h5>
                <h4>Chair</h4>
              </div>
            </div>
        ...
        <div class="classicsection withfooter lowpad">
          <div class="container">
            ...
            <h1 data-aos="fade-up"
                data-aos-delay="150"
                data-aos-duration="1000" data-aos-once="true" >US Senate</h1>
            <p data-aos="fade-up"
                data-aos-delay="300"
      ...
      <div id="modalOverlay">
        ...
        <div class="slide">
          <div class="modal">
            ...
            <div class="content">
              ...
              <h4>Irene Zhang</h4>
              <p>
                Currently a senior at Fraser Heights Secondary School, Irene is excited to serve as the chair for the US Senate at PacificMUN 2019. Ever since she attended her first Model UN conference in Grade 8, she has never been able to escape the intriguing world of Model UN. In her spare time, Irene enjoys drawing in the early hours of the morning, finding new bubble tea places to raid, and contemplating post-secondary decisions. She is also an avid fan of anime, often suffering heated internal debates over a bit more sleep or another episode. Regardless of whether you are a beginner or a veteran, Irene hopes that PacificMUN 2019 will foster important skills and create new friendships for all the delegates in the US Senate!
              </p>
            </div>
          </div>
        </div>
        ...
        <div class="slide">
          <div class="modal">
            ...
            <div class="content">
              <h3>Chair</h3>
              <h4>Hariette Zhang</h4>
              <p>
                Hattie is a senior at Southridge School and she is delighted to be Chairing at PACMUN 2019. Ever since commencing her Model UN career in Grade 10, she has been captivated by the thrill of researching, public speaking, debating, and collaborating with other passionate young people. At school, Hattie usually cries over APs, stresses over uni applications, and casually pretends that her sanity hasn’t evacuated from her body in fear of the next existential crisis. Outside of school, she enjoys reading, coding, competitive martial arts, and old Hollywood movies. This Chair is more than excited to meet all the delegates of the US Senate committee, seeing everyone do their research thoroughly and submitting their position papers on time!
              </p>
            </div>
          </div>
        </div>
