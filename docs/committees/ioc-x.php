...
<html lang="en" dir="ltr">
  <head>
    ...
    <title>IOC &mdash; Pacific Model United Nations</title>
...
-->
      ...
      <div class="landing committeepage">
        ...
        <img id="imgbg" src="../committees/img/ioc.jpg" alt="">
        <div class="frontpage">
          <div class="left">

            <h1 data-aos="fade-up"
                data-aos-delay="150"
                data-aos-duration="1000" data-aos-once="true">International Olympic Committee</h1>
            <h3 data-aos="fade-up"
                data-aos-delay="300"
      ...
      <main id="committeepage">
        <div class="topsection topicbg ioctopica">
          <div class="container">
            <h2 data-aos="fade-up"
                data-aos-duration="1000" data-aos-once="true">Topic A</h2>
            <h1 data-aos="fade-up"
                data-aos-delay="150"
                data-aos-duration="1000" data-aos-once="true">The Epidemic of Performance Enhancing Drugs in Athletic Competitions</h1>
            <p data-aos="fade-up"
                data-aos-delay="300"
                data-aos-duration="1000" data-aos-once="true">
                The Olympics are the most prestigious and celebrated sporting event in the world. They represent the pinnacle of success, the dream of every athlete, and the glory of every nation. Hosting the Olympics reflects the same level of pride: a privilege to display the Olympics through a nation’s eyes. However, the cost for hosting has risen tremendously over the past 50 years. This is only heightened with the emergence of  performance enhancing drugs (PED).
The act of using PED’s has been very heavily recorded with sources tracing as far back as Ancient Greece where runners often used mushrooms or herbal teas to improve stamina. In the 21st century, only by integrating modern technology and scientific advances in the sports field has allowed the isolated incident become an epidemic shocking the core values of the International Olympic Committee. The foundation of the IOC is at stake and it is up to delegates to not only establish fairness in sport, but punish all perpetrators of such tactics.
            </p>
            <div data-aos="fade-up"
                data-aos-delay="450"
                data-aos-duration="1000" data-aos-once="true" class="buttonfadeincontainer">
              <a class="button" href="backgrounders/IOC Topic A.pdf" target="_blank">Backgrounder <div class="rightarrow">&mdash;></div></a>
            </div>
          </div>
        </div>
        <div class="classicsection topicbg ioctopicb">
          <div class="container inverse">
            <h2 data-aos="fade-up"
                data-aos-duration="1000" data-aos-once="true">Topic B</h2>
            <h1 data-aos="fade-up"
                data-aos-delay="150"
                data-aos-duration="1000" data-aos-once="true">Host Nation Scandals and Corruption</h1>
            <p data-aos="fade-up"
                data-aos-delay="300"
                data-aos-duration="1000" data-aos-once="true">
In light of recent events, the process to choose host cities for the Olympic Games has come under great scrutiny. The fact that the process has been plagued by corruption in order to favor specific nations bids defeats the very principles in which the IOC focuses upon. Although recent events characterize these fundamental problems greatly, these issues can be traced back to previous games, decades before. Seeing as though this is the International Olympic Committee, the correction of such an issue should be held with the utmost importance. Also, the fact that corruption impedes on the IOC’s ability to spread its Olympic movement creates a false illusion of what the Olympics should be. In doing so, the fundamental reasoning for hosting the games is changed and therefore affected by external factors such as those caused by corruption.
<br><br>
There are many potential avenues for discussion in regards to this topic. Delegates must reconsider already existing voting methods as means of bringing about change for a potential corruption less process. Also, they must be able to look at the issue from a holistic standpoint that looks at corruption as a problem that affects all branches of the committee. Though the corruption in choosing host cities has been an issue since the inception of the games, through fruitful debate as well as comprehensive resolution, the issue can be solved.
            </p>
            <div data-aos="fade-up"
                data-aos-delay="450"
                data-aos-duration="1000" data-aos-once="true" class="buttonfadeincontainer">
              <a class="button" href="backgrounders/IOC Topic B.pdf" target="_blank">Backgrounder <div class="rightarrow">&mdash;></div></a>
            </div>
          </div>
        </div>
        <div class="classicsection lowpad">
          <div class="container">
            <h2 data-aos="fade-up"
                data-aos-delay="0"
                data-aos-duration="1000" data-aos-once="true" >IOC@pacificmun.org</h2>
            <h1 data-aos="fade-up"
                data-aos-delay="150"
            ...
            <div class="profiles"
              ...
              <div class="profile">
                <div class="profile-picture" onclick="openModal();currentSlide(1)">
                  <img src="img/staff/kiranbasra.jpg" alt="">
                </div>
                <h5>Kiran Basra</h5>
                <h4>Director</h4>
              </div>
              <div class="profile">
                <div class="profile-picture" onclick="openModal();currentSlide(2)">
                  <img src="img/staff/davidni.jpg" alt="">
                </div>
                <h5>David Ni</h5>
                <h4>Chair</h4>
              </div>
        ...
        <div class="classicsection withfooter lowpad">
          <div class="container">
            ...
            <h1 data-aos="fade-up"
                data-aos-delay="150"
                data-aos-duration="1000" data-aos-once="true" >IOC</h1>
            <p data-aos="fade-up"
                data-aos-delay="300"
                data-aos-duration="1000" data-aos-once="true" class="com-disc">
                The International Olympic Committee (IOC) will be a unique committee at Pacific MUN 2018. Although not a traditional UN body, The IOC continues to serve as the world’s utmost authority in regards to all Olympic-related matters. Although its role has diversified with the expansion of the Olympic Games in the modern era, it remains a leader from a logistical perspective. Additionally, the committee focuses on using the games as a tool to promote global social initiatives in coordination with the United Nations.
                <br><br>
                Additionally, it is important to note that the committee was originally founded in 1894, as a means of planning and coordinating the revitalization of the ancient games for the modern era. Since then, not only has it been the main organization committee for both the summer and winter games but has also expanded its role as a promoter of the global Olympic Movement. Furthermore, the IOC was granted permanent observer status by the UN and therefore plays a role in continuing its mission to use sports as a means to promote and maintain global peace.
            </p>
          </div>
        </div>
        ...
        <div class="slide">
          <div class="modal">
            ...
            <div class="content">
              ...
              <h4>Kiran Basra</h4>
              <p>
                Kiran Basra is a Grade 12 student attending Crofton House School who is honoured to serve as the Director of IOC. She has been a croftie since the first grade and has been debating for the past five years. Kiran has been fortunate enough to grow her interest for diplomacy and international relations through tournaments in countries such as Thailand, Czech Republic, and throughout Canada. Besides debate and MUN, Kiran enjoys playing volleyball and soccer, spending time at the beach, and eating her body weight in Mexican food with her friends and family. Kiran is looking forward to PacificMUN 2019, and encourages delegates to take advantage of the incredible learning opportunity that IOC and PacificMUN poses to them.
              </p>
            </div>
          </div>
        </div>
          ...
          <div class="slide">
            <div class="modal">
              ...
              <div class="content">
                ...
                <h4>Catherine Cho</h4>
                <p>
                  Catherine is a senior at York House School and is delighted to be serving as a chair for the IOC. She attended her first MUN conference in Grade 9 and has since found herself immersed in the world of international politics. Outside of MUN, Catherine can be found struggling to learn coding basics, listening to political podcasts, and indulging in Rain or Shine ice cream. Catherine looks forward to hearing the innovative solutions that will emerge in committee sessions and hopes that PacificMUN will be a memorable experience for all delegates!
                </p>
              </div>
            </div>
          </div>
