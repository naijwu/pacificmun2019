...
<html lang="en" dir="ltr">
  <head>
    ...
    <title>NATO &mdash; Pacific Model United Nations</title>
...
-->
      ...
      <div class="landing committeepage">
        ...
        <img id="imgbg" src="../committees/img/nato.jpg" alt="">
        <div class="frontpage">
          <div class="left">

            <h1 data-aos="fade-up"
                data-aos-delay="150"
                data-aos-duration="1000" data-aos-once="true">North Atlantic Treaty Organization</h1>
            <h3 data-aos="fade-up"
                data-aos-delay="300"
      ...
      <main id="committeepage">
        <div class="topsection topicbg natotopic">
          <div class="container">
            <h2 data-aos="fade-up"
                data-aos-duration="1000" data-aos-once="true">Topic</h2>
            <h1 data-aos="fade-up"
                data-aos-delay="150"
                data-aos-duration="1000" data-aos-once="true">Re-evaluation of NATO’s Role in The Modern Day</h1>
            <p data-aos="fade-up"
                data-aos-delay="300"
                data-aos-duration="1000" data-aos-once="true">
                NATO works towards the freedom and security of all members through the previously mentioned goals
  of collective defence, crisis management and cooperation. NATO is secondarily committed to individual
  liberty, democracy and human rights, along with the principles of the UN. Although the Euro-Atlantic area
  is relatively peaceful and not under threat of a substantive attack, there must be constant caution, as
  many more countries have developed modern military capabilities. The dangers of nuclear weapons
  continue to grow, threatening the security of the world at large.
            ...
            <div data-aos="fade-up"
              ...
              <a class="button" href="backgrounders/NATO.pdf" target="_blank">Backgrounder <div class="rightarrow">&mdash;></div></a>
            </div>
          </div>
        </div>
        <div class="classicsection lowpad">
          <div class="container">
            <h2 data-aos="fade-up"
                data-aos-delay="0"
                data-aos-duration="1000" data-aos-once="true" >nato@pacificmun.org</h2>
            <h1 data-aos="fade-up"
                data-aos-delay="150"
            ...
            <div class="profiles"
              ...
              <div class="profile">
                <div class="profile-picture" onclick="openModal();currentSlide(1)">
                  <img src="img/staff/andywang.jpg" alt="">
                </div>
                <h5>Andy Wang</h5>
                <h4>Director</h4>
              </div>
              ...
              <div class="profile">
                <div class="profile-picture" onclick="openModal();currentSlide(2)">
                  <img src="img/staff/dunstanwang.jpg" alt="">
                </div>
                <h5>Dunstan Wang</h5>
                <h4>Chair</h4>
              </div>
              ...
              <div class="profile">
                <div class="profile-picture" onclick="openModal();currentSlide(3)">
                  <img src="img/staff/leowang.jpg" alt="">
                </div>
                <h5>Leo Wang</h5>
                <h4>Chair</h4>
              </div>
        ...
        <div class="classicsection withfooter lowpad">
          <div class="container">
            ...
            <h1 data-aos="fade-up"
                data-aos-delay="150"
                data-aos-duration="1000" data-aos-once="true" >NATO</h1>
            <p data-aos="fade-up"
                data-aos-delay="300"
          ...
          <div class="slide">
            <div class="modal">
              ...
              <div class="content">
                ...
                <h4>Dunstan Wang</h4>
                <p>
                  PacificMUN 2019 will be Dunstan's 3rd time attending PacificMUN, and his second time as a staff member. Being a washed-up high school MUNer, Dunstan wishes to revisit his favorite conference and provide the same awesome experience of MUN to the delegates in his committee. He currently attends UBC and is struggling under the new threat of constant midterms. Dunstan loves to chat about music, philosophy, Overwatch, or just about anything else so feel free to message him anytime to get to know him better. He knows that NATO will be a blast for everyone involved, and can't wait to see everyone there.
                </p>
              </div>
            </div>
          </div>
        ...
        <div class="slide">
          <div class="modal">
            ...
            <div class="content">
              ...
              <h4>Leo Wang</h4>
              <p>
                Leo Wang is a Grade 11 student attending University Hill Secondary School and he is truly
ecstatic to be the Chair of NATO at PacificMUN 2019. Ever since timidly raising his placard for
the very first time in grade 9, he has fallen in love with engaging in the world of international
affairs; an opportunity provided nowhere else except in Model UN. In his spare time, one can
find Leo attending local debate tournaments, catching up on his favourite Netflix shows, and
playing basketball at his community center. He always looks forward to meeting new people at
Model UN conferences and cannot wait to make PacificMUN 2019 another successful iteration!
              </p>
            </div>
          </div>
        </div>
